...
public class MeetingController {
    ...
    public ResponseEntity<Map<String, Object>> createToken(
        ...
        try {
            // 미팅 생성
            meetingService.create(member.getMemberId(), meetingCreateRequestDto);
            log.info("✅ 미팅 생성 완료");
            
            // 토큰 생성
            Map<String, Object> tokenResult = meetingService.createToken(meetingCreateRequestDto.getTitle(), member.getEmail());
    ...
    public ResponseEntity<Map<String, String>> endMeeting(
        ...
        meetingService.endMeeting(member.getEmail(), meetingId);
    ...
    public ResponseEntity<Map<String, String>> leave(
            @AuthenticationPrincipal SecurityMember member,
            @PathVariable Long meetingId) {
        meetingService.leaveSession(meetingId, member.getEmail());
    ...
    public ResponseEntity<List<ClassMeetingInfoResponseDto>> getLiveList(
        ...
        return ResponseEntity.ok(meetingService.getMeetingList(member.getEmail(), classId));
    }
